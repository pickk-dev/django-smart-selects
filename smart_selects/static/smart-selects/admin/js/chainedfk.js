var chainedfk = {
    ...
    init: function (chainfield, url, id, init_value, empty_label, auto_choose) {
        ...
        $(chainfield).change(function () {
            ...
            if ($(this).attr("id") == "id_item_major_type") {
                var prefix, start_value, this_val, localID = '#id_item_minor_type';
            } else if ($(this).attr("id") == "id_item_minor_type") {
                var prefix, start_value, this_val, localID = '#id_item_final_type';
            } else {
